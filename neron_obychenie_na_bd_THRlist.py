...
nltk.download('punkt')
bank = pd.read_excel('thrlist.xlsx')
text = bank.iloc[0]['Наименование УБИ']
...
bank['Preprocessing_text_НАИМЕНОВАНИЕ_УБИ'] = bank.apply(lambda row: preprocess(row['Наименование УБИ'], marks, stop_words, morph), axis=1)
bank['Preprocessing_text_Описание'] = bank.apply(lambda row: preprocess(row['Описание'], marks, stop_words, morph), axis=1)
...
print(B)
print(modelf.wv.most_similar('файл'))
print('..................................')
print(model.wv.most_similar('файл'))
model.save('obuchenie_bazadan_thrlist')
